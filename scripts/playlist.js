...
var ytEmbed = {
    ...
    init: function(cfg) {
        ...
        this.cfg.key = 'AIzaSyAuyY0Z60R6floekP1gs99tlOmhh0dEDSI';
        ...
        if (!this.cfg.block) {
            ...
            if (!this.cfg.type) {
                ...
                if (!this.cfg.height) {
                    this.cfg.height = 390*1.5;
                }
                if (!this.cfg.width) {
                    this.cfg.width = 640*1.5;
                }
...
ytEmbed.init({'block':'ytThumbs','q':'PLxOe12I5kXb3e04Ulc4TV8zHTSyuWB22X','type':'playlist','results':20,'meta':true,'player':'embed','layout':'thumbnails', 'display_first':true});